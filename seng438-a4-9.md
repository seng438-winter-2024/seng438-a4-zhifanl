...
|-------------|------|-----------------------------------------------------------------------------------|-------------------|
| 1           | 176  | Replaced boolean return with false for `org/jfree/data/Range::intersects`         | The test suite successfully detected and killed this mutation, indicating the test is effective at validating true conditions for intersects method. |
| 2           | 176  | Replaced boolean return with true for `org/jfree/data/Range::intersects`          | This mutation was killed by the test suite, showing the tests are capable of identifying false positives in intersects validation. |
| 3           | 176  | Removed call to `org/jfree/data/Range::getLowerBound`                             | The mutation was killed, suggesting the tests depend on the lower bound for determining range intersections accurately. |
